...
replace golang.org/x/tools => github.com/golang/tools v0.0.0-20181030221726-6c7e314b6563

replace gopkg.in/jcmturner/gokrb5.v7 => github.com/jcmturner/gokrb5 v7.2.3+incompatible

require github.com/TarsCloud/TarsGo v0.0.0-20200116073431-aeab399aaf93
